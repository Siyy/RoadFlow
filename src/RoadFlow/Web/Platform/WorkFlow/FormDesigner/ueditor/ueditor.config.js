...
, toolbars: [["fullscreen", "source", "undo", "redo", "insertunorderedlist", "insertorderedlist", "bold", "italic", "underline",
    "strikethrough", "justifyleft", "justifycenter", "justifyright", "justifyjustify", "superscript", "subscript", "fontfamily", "fontsize", "paragraph", "customstyle", "fontborder", "forecolor", "backcolor", "touppercase", "tolowercase",
    "rowspacingbottom", "rowspacingtop", "lineheight", "indent", "autotypeset", "pagebreak", "unlink",
    "link", "cleardoc", "selectall", "searchreplace", 
    "drafts", "gmap", "map", "insertimage", "music", "snapscreen", "emotion", "scrawl", "insertvideo", "attachment", "insertframe",
    "date", "time", "wordimage", "horizontal", "anchor", "spechars", "blockquote", "pasteplain", "insertcode", "template", "background",
