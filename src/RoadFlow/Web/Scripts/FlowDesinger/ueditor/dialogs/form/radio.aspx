...
<script type="text/javascript">
    var text = getElement(editor, "flow_radio", "formradioDialog");
    ...
    dialog.onok = function ()
    {
        ...
        var html = '<input ondblclick="if(editor.ui._dialogs.formradioDialog.iframeUrl.indexOf(\'?\')==-1){editor.ui._dialogs.formradioDialog.iframeUrl=editor.ui._dialogs.formradioDialog.iframeUrl+\'?edit=1\';}editor.ui._dialogs.formradioDialog.open();" title="双击可设置属性" type="text" value="单选按钮组" type1="flow_radio" id="' + id + '" name="' + id + '" datasource="' + datasource + '" dictid="' + dictid + '" ';
        if ("1" == datasource)
        {
