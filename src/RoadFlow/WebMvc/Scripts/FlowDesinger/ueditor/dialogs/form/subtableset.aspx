        ...
        <td colspan="2">
            <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                <tr>
                    ...
                    <td><select class="myselect" id="text_defaultvalue" style="width:227px"><%=defaultOptions %></select></td>
                </tr>
                <tr>
                    <th>值类型:</th>
    ...
    <tr id="mode_textarea" style="display:none;">
        <td colspan="2">
            <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                <tr>
                    <th style="width:100px;">默认值:</th>
                    <td><select class="myselect" id="textarea_defaultvalue" style="width:227px"><%=defaultOptions %></select></td>
                </tr>
                <tr>
                    <th>值类型:</th>
    ...
    <tr id="mode_datetime" style="display:none;">
        <td colspan="2">
            <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                <tr>
                    <th style="width:100px;">默认值:</th>
                    <td><select class="myselect" id="datetime_defaultvalue" style="width:227px"><%=defaultOptions %></select></td>
                </tr>
