...
<table cellpadding="0" cellspacing="1" border="0" width="95%" id="ds_sql" style="display:none; margin-top:5px;" align="center">
    <tr>
        <td colspan="2">
...
<script type="text/javascript">
    var text = getElement(editor, "flow_checkbox", "formcheckboxDialog");
    ...
    dialog.onok = function ()
    {
        ...
        var html = '<input ondblclick="if(editor.ui._dialogs.formcheckboxDialog.iframeUrl.indexOf(\'?\')==-1){editor.ui._dialogs.formcheckboxDialog.iframeUrl=editor.ui._dialogs.formcheckboxDialog.iframeUrl+\'?edit=1\';}editor.ui._dialogs.formcheckboxDialog.open();" title="双击可设置属性" type="text" value="复选按钮框" type1="flow_checkbox" id="' + id + '" name="' + id + '" datasource="' + datasource + '" dictid="' + dictid + '" ';
        if ("1" == datasource)
        {
        ...
        editor.execCommand("formcheckbox", html);
        dialog.close();
    }
</script>
</body>
