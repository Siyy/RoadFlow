...
<script type="text/javascript">
    var text = getElement(editor, "flow_subtable", "formsubtableDialog");
    ...
    function filedEditSet(field)
    {
        top.mainDialog.open({
            id: "from_set_" + field,
            url: top.rootdir + "/Scripts/FlowDesinger/ueditor/dialogs/form/subtableset.aspx?eid=set_" + field,
    ...
    dialog.onok = function ()
    {
        ...
        var html = '<input ondblclick="if(editor.ui._dialogs.formsubtableDialog.iframeUrl.indexOf(\'?\')==-1){editor.ui._dialogs.formsubtableDialog.iframeUrl=editor.ui._dialogs.formsubtableDialog.iframeUrl+\'?edit=1\';}editor.ui._dialogs.formsubtableDialog.open();" title="双击可设置属性" type="text" isflow="1" readonly="readonly" type1="flow_subtable" id="' + id + '" style="width:99%;height:50px;" value="从表" ';
        html += '/>';
        json.id = id;
        var isadd = true;
        for (var i = 0; i < parent.formsubtabs.length; i++)
        ...
        editor.execCommand("formsubtable", html);
        dialog.close();
    }
</script>
</body>
