...
<script type="text/javascript">
    var text = getElement(editor, "flow_select", "formselectDialog");
    ...
    dialog.onok = function ()
    {
        ...
        var html = '<input ondblclick="if(editor.ui._dialogs.formselectDialog.iframeUrl.indexOf(\'?\')==-1){editor.ui._dialogs.formselectDialog.iframeUrl=editor.ui._dialogs.formselectDialog.iframeUrl+\'?edit=1\';}editor.ui._dialogs.formselectDialog.open();" title="双击可设置属性" type="text" type1="flow_select" id="' + id + '" name="' + id + '" datasource="' + datasource + '" dictid="' + dictid + '" value="下拉列表框" ';
        if (width)
        {
        ...
        editor.execCommand("formselect", html);
        dialog.close();
    }
</script>
</body>
